          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="space-y-5 md:space-y-8">
              <div className="space-y-3 text-center">
                <h2 className="font-raleway text-4xl  text-white">
              ...
              <div className="flex flex-col items-start space-y-3">
                <button
                  type="button"
                  className="hs-collapse-toggle py-5 px-4 w-full inline-flex items-center justify-between gap-x-2 text-md font-raleway rounded-lg border border-transparent text-white bg-[#5297c2] hover:bg-[#71a7c7] focus:outline-none focus:bg-[#71a7c7] disabled:opacity-50 disabled:pointer-events-none"
                ...
                >
                  Data Collection
                  <MdKeyboardArrowDown
                    className={`hs-collapse-open:rotate-180 shrink-0 ${
