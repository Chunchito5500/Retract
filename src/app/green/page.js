            ...
            <div className="space-y-5 md:space-y-8">
              <div className="space-y-3 text-center">
                ...
                <p className="text-md font-convergence text-neutral-200">
                  ...
                  eliminate the inconvenience of carrying and storing them. With
                  Retractability, you can enjoy the best aspects of biking with
                  the added convenience of easy storage and transport.
                </p>
              </div>
              <figure>
                <Image
              ...
              <blockquote className="text-center p-4 sm:px-7">
                <p className="text-xl font-medium text-gray-800 md:text-2xl md:leading-normal xl:text-2xl xl:leading-normal dark:text-neutral-200">
                  &quot;Only at Retractability, can you count on the best of the
                  best&quot;
                </p>
