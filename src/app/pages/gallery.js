        ...
        >
          ...
          <div class=" bg-[#e6ebe0]">
            ...
            >
              <figure>
                <model-viewer
                  src="Bike Unfolded/Bike Unfolded.gltf"
                  ar
                  ar-modes="webxr scene-viewer quick-look"
                  camera-controls
                  tone-mapping="commerce"
              ...
              >
                <h2 class="card-title">Wheel!</h2>
                <p>Look at this wheel!</p>
        ...
        >
          ...
          <div class=" bg-[#e6ebe0]">
            ...
            >
              <figure>
                <model-viewer
                  src="Tire Folded/Tire Folded.gltf"
                  ar
                  ar-modes="webxr scene-viewer quick-look"
                  camera-controls
                  tone-mapping="commerce"
          ...
          <div class=" bg-[#e6ebe0]">
            ...
            >
              <figure>
                <model-viewer
                  src="Tire Unfolded/Tire Unfolded.gltf"
                  ar
                  ar-modes="webxr scene-viewer quick-look"
                  camera-controls
                  tone-mapping="commerce"
                ...
                <figure>
                  <model-viewer
                    ...
                    style={{
                      ...
                      height: "500px",
                      border: "2px solid #9bc1bc",
                      transform: "rotateX(180deg)", // Example from one of your model-viewer components
                    }}
                  >
                    <div class="progress-bar hide" slot="progress-bar">
                      <div class="update-bar"></div>
