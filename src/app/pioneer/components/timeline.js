  ...
  return (
    <div>
      ...
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
        <div className="text max-w-3xl mb-10 lg:mb-14">
          <h2
            className={`text-white font-semibold text-2xl md:text-4xl md:leading-tight ${BebasNeue.className}`}
          >
            Our Timeline
          </h2>
          <p class="mt-1 text-neutral-400">
            Our goals for the near future. Every step shared. <br />
            So <strong>you</strong> can keep track of Retractability.
          </p>
        </div>
