    ...
    <div className="relative">
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto text-center mb-16">
          <h2 className={`text-xl font-bold md:text-2xl md:leading-tight text-white/80 ${Roboto.className}`}>A closer look at</h2>
          <p className={`mt-2 text-5xl md:text-6xl text-[#faf8f4] font-bold ${BebasNeue.className}`}>Our Tire</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
          <div className="group border-2 border-[#faf8f4]/20 rounded-3xl p-6 hover:border-[#faf8f4]/40 transition-colors duration-300">
            <div className="relative w-full h-[400px] rounded-2xl overflow-hidden mb-6 bg-gradient-to-br from-gray-900 to-gray-800">
              <Image src="/thetire/tire.jpeg" alt="Airless tire technology" width={600} height={400} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out"/>
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
            </div>
            <div className="space-y-4">
              <h3 className={`text-3xl md:text-4xl font-bold text-[#ccc5b9] ${BebasNeue.className}`}>Airless Tires</h3>
              <p className={`text-[#faf8f4]/90 text-lg leading-relaxed ${Roboto.className}`}>No more flats. No more patch kits. Just pure ride-time. Our revolutionary airless design eliminates the most common bike maintenance issue.</p>
            </div>
          </div>

          <div className="group lg:col-span-1" ref={middleCardRef}>
            <div className="text-center mb-8">
              <h3 className={`text-3xl md:text-4xl font-bold text-[#faf8f4] leading-tight ${BebasNeue.className}`}>We&apos;ve Reinvented the Wheel</h3>
            </div>
            <div className="relative rounded-2xl overflow-hidden">
              {isModelLoaded ? (
                <ModelViewer
                  ...
                  style={{ width: '100%', height: '450px', background: 'transparent' }}
                  interaction-policy="none"
                >
                  <div className="progress-bar hide" slot="progress-bar">
                    <div className="update-bar" />
                  </div>
                  <button slot="ar-button" id="ar-button" className="absolute bottom-4 right-4 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">View in AR</button>
                  <div id="ar-prompt" />
                </ModelViewer>
              ) : (
                <div className="flex items-center justify-center h-[450px]">
                  <div className="text-center">
                    ...
                    <p className={`text-[#faf8f4]/70 ${Roboto.className}`}>Loading 3D Model...</p>
                  </div>
                </div>
              )}
            </div>
            <div className="mt-8 text-center max-w-md mx-auto">
              <p className={`text-[#faf8f4]/80 text-base leading-relaxed ${Roboto.className}`}>Built with lightweight materials and enhanced traction for commuters, students, and city explorers who demand durability without compromise.</p>
            </div>
          </div>

          <div className="group border-2 border-[#faf8f4]/20 rounded-3xl p-6 hover:border-[#faf8f4]/40 transition-colors duration-300">
            <div className="relative w-full h-[400px] rounded-2xl overflow-hidden mb-6 bg-gradient-to-br from-gray-200 to-gray-300">
              <Image src="/thetire/spoke.jpeg" alt="Reengineered spokes design" width={600} height={400} className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out"/>
              <div className="absolute inset-0 bg-gradient-to-t from-white/40 via-transparent to-transparent" />
            </div>
            <div className="space-y-4">
              <h3 className={`text-3xl md:text-4xl font-bold text-[#ccc5b9] ${BebasNeue.className}`}>Reengineered Spokes</h3>
              <p className={`text-[#faf8f4]/90 text-lg leading-relaxed ${Roboto.className}`}>Structural strength that folds with you. Our innovative spoke design maintains wheel integrity while enabling seamless folding mechanics.</p>
            </div>
          </div>
        </div>

        <div className="text-center mt-16">
          <p className={`text-xl md:text-2xl text-white font-light ${Roboto.className}`}>This is more than just a new tire, it&apos;s a new standard.</p>
        </div>
      </div>
